...
# TEST
print('-' * 40)
print('>>> fruits = DictionnaireOrdonne()')
print('>>> fruits')
...
print('-' * 40)
print('>>> fruits["pomme"] = 52')
print('>>> fruits["poire"] = 34')
print('>>> fruits["prune"] = 128')
print('>>> fruits["melon"] = 15')
print('>>> fruits')
fruits["pomme"] = 52
fruits["poire"] = 34
fruits["prune"] = 128
...
print('-' * 40)
print('>>> legumes = DictionnaireOrdonne(carotte = 26, haricot = 48)')
print('>>> legumes')
...
print('-' * 40)
print('>>> legumes.reverse()')
print('>>> fruits = fruits + legumes')
print('>>> fruits')
legumes.reverse()
...
print('-' * 40)
print('>>> for nom, qtt in legumes.items():')
print('>>>     print("{0} ({1})".format(nom, qtt))')
